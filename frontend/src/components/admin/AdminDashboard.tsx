  ...
  return (
    <div className="space-y-8">
        ...
        <div className="card-modern p-6">
          ...
          <div className="space-y-4">
            {recentActivity.map((activity, index) => (
              <div
                key={index}
                className={`flex items-center gap-3 p-3 glass-surface rounded-xl border transition-all duration-300 ${activity.priority === 'high'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <div className="card-modern p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className={`flex items-center gap-3 p-3 glass-surface rounded-xl border ${flaggedIssues.length > 0
                ? 'border-red-500/20'
                : 'border-green-500/20'
                }`}>
                <div className={`w-3 h-3 rounded-full animate-pulse ${flaggedIssues.length > 0 ? 'bg-red-500' : 'bg-green-500'
                  }`}></div>
                <div>
                  <div className={`font-medium ${flaggedIssues.length > 0 ? 'text-red-500' : 'text-green-500'
                    }`}>
                    Flag Monitoring
                  </div>
        ...
        <ConnectionTest className="lg:col-span-1" />
      </div>
    </div>
  );
} 