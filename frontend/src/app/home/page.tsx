            ...
            <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
                <div className="text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-slide-up" style={{ animationDelay: '0.2s' }}>
                        <Link
                            href="/issues"
                            className="group glass-surface border border-accent-primary text-accent-primary px-10 py-5 rounded-2xl text-lg font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-1"
                        >
                        ...
                        <Link
                            href="/report"
                            className="group btn-modern px-10 py-5 rounded-2xl text-lg font-semibold hover:scale-105 hover:-translate-y-1"
                        >
                            <span className="flex items-center gap-3">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="group card-modern p-8 hover:border-accent-primary transition-all duration-300 hover:-translate-y-2" style={{ animationDelay: '0.2s' }}>
                            <div className="w-16 h-16 bg-gradient-to-r from-neon-green to-iridescent-purple dark:from-bright-blue dark:to-vibrant-pink rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="card-modern p-12 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                            <Link
                                href="/signup"
                                className="btn-modern px-10 py-4 text-lg font-semibold hover:scale-105"
                            >
                                Get Started Today
                            </Link>
                            <Link
                                href="/issues"
                                className="glass-surface border border-accent-primary text-accent-primary px-10 py-4 rounded-2xl text-lg font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105"
                            >
                                Explore Issues
                            </Link>
                        </div>
